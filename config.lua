Garages = {
    ...
    ['elysian'] = {
        ...
        spawnPoint = {
            vector4(162.67, -2989.88, 5.19, 270.57),
            vector4(162.55, -2992.99, 5.21, 270.67),
            vector4(162.57, -2996.28, 5.22, 269.38),
            vector4(162.17, -3002.88, 5.23, 270.07),
            vector4(162.66, -3006.12, 5.22, 269.57),
            vector4(162.73, -3009.26, 5.22, 269.6),
		},
		blippoint = vector3(162.63, -2998.18, 5.95),
        showBlip = true,
		blipsprite = 357,
		blipscale = 0.6,
		blipcolour = 3,
		...
		zones = {
            		vector2(159.31, -3011.0),
            		vector2(165.43, -3011.36),
            		vector2(165.56, -2987.38),
            		vector2(159.21, -2987.42),
        },
  		minZ = 4.19,
  		maxZ = 10.22,
    },
    ...
    ['new'] = {
        ...
        spawnPoint = {
            -- Left Side
            vector4(-878.07, -2346.71, 13.23, 243.16),
            vector4(-876.58, -2343.67, 13.23, 244.32),
            vector4(-875.1, -2340.47, 13.24, 242.01),
            vector4(-873.36, -2337.43, 13.23, 244.54),
            vector4(-872.04, -2334.31, 13.23, 242.15),
            vector4(-870.55, -2331.28, 13.23, 240.97),
            vector4(-868.91, -2328.2, 13.23, 242.45),

            -- Right Side
            vector4(-859.28, -2353.69, 13.23, 83.88),
            vector4(-859.38, -2350.15, 13.24, 83.24),
            vector4(-858.74, -2346.73, 13.23, 84.67),
            vector4(-858.46, -2343.38, 13.23, 86.94),
            vector4(-858.22, -2339.83, 13.23, 84.21),
            vector4(-857.85, -2336.42, 13.23, 84.78),
            vector4(-858.06, -2333.0, 13.23, 85.79),
		},
		blippoint = vector3(-868.64, -2344.82, 13.96),
        showBlip = true,
		blipsprite = 357,
		blipscale = 0.6,
		blipcolour = 3,
		...
		canStoreVehicle = true,
		zones = {
            vector2(-882.32, -2347.54),
            vector2(-868.83, -2355.53),
            vector2(-855.99, -2356.24),
            vector2(-854.3, -2330.97),
            vector2(-871.1, -2324.47),
        },
  		minZ = 12.23,
  		maxZ = 18.97,
    },
    ...
    ['vespbs'] = {
        ...
        spawnPoint = {
            	vector4(-1142.05, -740.8, 19.42, 286.53),
            	vector4(-1139.7, -743.68, 19.26, 288.2),
		vector4(-1137.33, -746.61, 19.13, 286.49),
		vector4(-1134.82, -749.54, 18.99, 288.76),
		vector4(-1132.28, -752.55, 18.85, 286.05),
		vector4(-1129.78, -755.67, 18.7, 288.47),
		vector4(-1127.42, -758.6, 18.55, 286.87),
		vector4(-1145.63, -745.59, 19.05, 107.75),
		vector4(-1143.14, -748.59, 18.9, 107.57),
		vector4(-1140.62, -751.56, 18.76, 107.55),
		vector4(-1138.19, -754.46, 18.62, 107.89),
		vector4(-1135.53, -757.42, 18.47, 108.28),
		vector4(-1133.88, -760.57, 18.28, 107.13),
		vector4(-1130.93, -763.44, 18.14, 107.67),
		},
		blippoint = vector3(-1139.61, -751.57, 19.38),
        showBlip = true,
		blipsprite = 357,
		blipscale = 0.6,
		blipcolour = 3,
		...
		canStoreVehicle = true,
		zones = {
            vector2(-1122.48, -759.87),
            vector2(-1131.45, -767.76),
            vector2(-1150.93, -744.31),
            vector2(-1142.25, -736.61),
        },
  		minZ = 17.14,
  		maxZ = 23.14,
    },
	...
	['altastreet'] = {
        label = 'Alta Street',
        spawnPoint = {
			vector4(-297.97, -990.53, 30.35, 338.5),
			vector4(-301.28, -988.94, 30.36, 340.53),
			vector4(-304.9, -987.73, 30.36, 339.02),
			vector4(-308.3, -986.47, 30.36, 339.96),
			vector4(-311.74, -985.35, 30.35, 341.18),
			vector4(-315.2, -984.03, 30.35, 338.41),
			vector4(-318.69, -982.52, 30.36, 339.84),
			vector4(-322.26, -981.42, 30.36, 338.86),
			vector4(-325.65, -980.24, 30.35, 341.13),
			vector4(-328.93, -978.44, 30.36, 340.81),
			vector4(-332.64, -977.58, 30.35, 339.48),
			vector4(-336.14, -976.46, 30.35, 338.94),
			vector4(-339.57, -975.06, 30.36, 339.43),
			vector4(-342.97, -973.81, 30.35, 338.15),
		},
		blippoint = vector3(-322.17, -981.71, 31.08),
        showBlip = true,
		blipsprite = 357,
		blipscale = 0.6,
		blipcolour = 3,
		...
		canStoreVehicle = true,
		zones = {
            		vector2(-296.9, -994.42),
			vector2(-294.75, -988.0),

			-- Damage side
			vector2(-343.75, -970.22),
			vector2(-346.0, -976.41),
        },
        minz = 30.08,
        maxz = 36.08,
    },
	['burton'] = {
        label = 'Burton',
        spawnPoint = {
		vector4(-500.73, -175.11, 36.98, 209.63),
		vector4(-498.06, -179.81, 36.83, 209.63),
		vector4(-494.95, -185.3, 36.67, 209.6),
		vector4(-492.14, -190.25, 36.52, 209.6),
		vector4(-488.91, -195.95, 36.35, 209.56),
		vector4(-486.15, -200.83, 36.2, 209.55),
		vector4(-483.06, -206.29, 36.04, 209.5),
		vector4(-480.1, -210.88, 35.9, 209.44),
		vector4(-476.79, -216.72, 35.73, 209.49),
		vector4(-473.92, -221.67, 35.58, 208.85),			
	},
		blippoint = vector3(-485.42, -202.14, 36.89),
        		showBlip = true,
		blipsprite = 357,
		blipscale = 0.6,
		blipcolour = 3,
		...
		canStoreVehicle = true,
		zones = {
            		vector2(-501.74, -169.86),
			vector2(-502.75, -175.21),
			vector2(-475.07, -223.04),
			vector2(-469.93, -224.97),
        },
        minz = 34.58,
        maxz = 40.58,
    },
